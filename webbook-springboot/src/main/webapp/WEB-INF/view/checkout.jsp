            ...
            <div class="detail-cart">
                <table class="list">
                    ...
                    <c:forEach var="map" items="${sessionScope.myCartItems}">
                        <tr>
                            <td>
                                <a href="/product?id=${map.value.product.id}">
                                    <img src="${map.value.product.image}" class="img-check-out" alt="book-buy">
                                </a>
                            </td>
                            ...
                            <td>
                                <a href="/remove?id=${map.value.product.id}" id="delete-product-in-cart">Xóa</a>
                            </td>
                        </tr>
                    </c:forEach>
