                ...
                <div class="content-left">
                    <div class="product-img-price">
                        <div class="img-product-hero">
                            <img src="${productSelected.image}" alt="img-product">
                        </div>
                        <div class="title-product">
                            ...
                            <div class="add-to-cart">
                                ...
                                <c:if test="${sessionScope.user != null}">
                                    ...
                                    <a href="/add?id=${productSelected.id}" id="add-to-cart" onclick="setQuantity('addToCart')" class="add-item-cart-related"><i class="fa fa-shopping-cart"></i></a>
                                </c:if>
                                ...
                                <c:if test="${sessionScope.user != null}">
                                    <a href="/buynow?id=${productSelected.id}" id="buy-more-product" onclick="setQuantity('buyMore')" class="buy-now">Mua ngay</a>
                                </c:if>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="product-list">
                        <c:forEach var="product" items="${lstProductSameCategory}">
                            <div class="product-item-related">
                                <a href="/product?id=${product.id}"><img src="${product.image}" alt="img-product" class="img-product-related"></a>
                                <div class="product-item-detail-related">
                                    ...
                                    <div class="product-buy-detail-related">
                                        ...
                                        <c:if test="${sessionScope.userName != null}">
                                            <a href="/add?id=${productSelected.id}" class="add-item-cart-related"><i class="fa fa-shopping-cart"></i></a>
                                        </c:if>
                                        <a href="/product?id=${product.id}" class="item-detail-related">Details<i class="fa fa-chevron-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        </c:forEach>
                        ...
                        <div class="list-product-body">
                            <c:forEach var="product" items="${lstProductsByTime}">
                                <div class="product-item-mini">
                                    <a class="img-product-item" href="/product?id=${product.id}">
                                        <img src="${product.image}" alt="img-product" class="img-product-mini">
                                    </a>
