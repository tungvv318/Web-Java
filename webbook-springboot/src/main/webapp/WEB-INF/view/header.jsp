...
<div id="headerScreen">
    <div class="header">
                                            ...
                                            <div id="myDropdown" class="dropdown-content">
                                                <c:forEach var="map" items="${sessionScope.myCartItems}">
                                                    <div class="item-in-cart">
                                                        <a href="/product?id=${map.value.product.id}" class="link-product"><img src="${map.value.product.image}" alt="book-img"></a>
                                                        <div class="detail-product-buy">
                                                            <a href="/product?id=${map.value.product.id}"><p class="overide-line-height">${map.value.product.name}</p></a>
                                                ...
                                                <a href="/checkout" class="buy-total">Xem Giỏ Hàng</a>
                                            </div>
                                        </c:if>
                                    </c:if>
                                </div>
        ...
        <div class="header-bottom">
            <div class="container">
                <ul class="header-nav">
                    <li><a href="/index" class="current-nav">Trang chủ</a></li>
                    <li>
                        <a class="current-nav" href="/category">Danh mục sách</a>
                        <ul class="header-sub-nav">
                            <c:forEach var="category" items="${lstCategory}">
                                <li class="sub-list">
                                    <a href="/category?idCategory=${category.id}">${category.name} </a>
                                </li>
                            </c:forEach>
                        </ul>
                    </li>
