...
<head>
    ...
    <link href="/css/productfind.css" rel="stylesheet">
</head>
<body>
<div id="productFind">
        ...
        <div class="container">
            ...
            <c:forEach var="productSearch" items="${lstProductSearch}">
                <div class="product-item">
                    <a href="/product?id=${productSearch.id}"><img src="${productSearch.image}" class="img-product"></a>
                    <div class="product-item-detail">
                        ...
                        <div class="product-buy-detail">
                            <a href="/add?id=${productSearch.id}" class="add-item-cart"><i class="fa fa-shopping-cart"></i></a>
                            <a href="/product?id=${productSearch.id}" class="item-detail">Details<i class="fa fa-chevron-right"></i></a>
                        </div>
                    </div>
                </div>
            </c:forEach>
